module.exports = {
  'governance': [
    ...
    {name: 'Karissa McKelvey', github: 'karissa', description: 'Karissa is a board member at Code for Science & Society and developer on Dat Project. She is a developer with Digital Democracy. Former <a href="http://scholar.google.com/citations?user=RM2tB8EAAAAJ&hl=en">academic</a> experienced in building interactive data visualization and collaboration tools.'},
  ...
  'other': [
    ...
    {name: 'Jim Pick', github: 'jimpick', description: 'Consultant for Dat Project software and builder of cool Dat demos. Co-host of <a href="https://twitter.com/dat_cast">@dat_cast podcast</a>.'}
  ],
  'alumni': [
